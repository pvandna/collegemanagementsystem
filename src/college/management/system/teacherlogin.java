...
public class teacherlogin  extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent obj)
    {
      ...
      String username=jtuname.getText();   
       String id=jtpassword.getText();
       
       
        String query = "SELECT name, empid FROM teacher WHERE name='" + username + " ' AND empid='" + id + " '";
       try
       {
         ...
         ResultSet rs= con1.s.executeQuery(query);  
          ...
          {  
            ...
            new teacherproject();                               //then open next frame
