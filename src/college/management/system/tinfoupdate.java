...
public class tinfoupdate extends JFrame implements ActionListener{
    ...
    tinfoupdate()
             {
                 ...
                 JLabel lblrollnumber=new JLabel("Sellect  empId ");
            ...
            System.out.println(e);
              ...
              /*   JLabel  lblx=new JLabel("class X %");
                ...
                add(labelaadhar);*/
                 ...
                 JLabel  lblbranch=new JLabel("Dept.");
                 //lblbranch.setBounds(400,350,250,30);
                 lblbranch.setBounds(50,200,200,30);
                ...
                tfbranch.setBounds(200,200,200,30);
                 add(tfbranch);
                 ...
                 try
                 {
                     ...
                     while(rs.next())
                     {
                        ...
                        // labelempid.setText(rs.getString("empid"));
                         tfcourse.setText(rs.getString("highest_edu"));
                 ...
                 cempid .addItemListener(new ItemListener ()                                 //inside calling  start
                 {
...
public void actionPerformed(ActionEvent ae)
{
    ...
    {  
       ...
       try
       {
           String query="update  teacher  set address='"+address+" ' ,phone= '"+phone+" ', email='"+email+" ',highest_edu='"+course+" ', department= '"+branch+" ' where empid='"+empid+"' ";
           conn con=new conn();
           con.s.executeUpdate(query);
           JOptionPane.showMessageDialog(null,"teacher detail updated sucessfully");
           setVisible(false);
